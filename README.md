...
- **Cryptographic Human Authorization** - high-risk actions require step-up approval where the operator cryptographically signs the transaction payload using non-extractable keys in the browser via the Web Crypto API.
